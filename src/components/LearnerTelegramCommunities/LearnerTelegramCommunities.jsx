...
const LearnerTelegramCommunities = () => {
  return (
    <div className="max-w-[80%] mb-6 mx-auto">
      <h2 className="text-3xl font-semibold text-gray-800 mb-6">Telegram Communities (0)</h2>
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="px-6 py-3 text-left text-lg font-semibold text-gray-700">DATE PURCHASED</th>
              ...
              <th className="px-6 py-3 text-left text-lg font-semibold text-gray-700">PLAN TYPE</th>
              <th className="px-6 py-3 text-left text-lg font-semibold text-gray-700">INVITE LINK</th>
            </tr>
          </thead>
          <tbody>
            <tr>
...
export default LearnerTelegramCommunities;
