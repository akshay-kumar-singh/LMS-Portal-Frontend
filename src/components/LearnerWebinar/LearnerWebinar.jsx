...
const LearnerWebinar = () => {
  return (
    <div className="max-w-[80%] mb-6 mx-auto">
      <h2 className="text-3xl font-semibold text-gray-800 mb-6">Webinar (0)</h2>
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="px-6 py-3 text-left text-lg font-semibold text-gray-700">ATTENDED</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td colSpan="3" className="px-6 py-4 text-center text-lg text-gray-600">
