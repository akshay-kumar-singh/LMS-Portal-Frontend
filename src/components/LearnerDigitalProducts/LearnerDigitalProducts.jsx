...
const LearnerDigitalProducts = () => {
  return (
    <div className="max-w-[80%] mb-6 mx-auto">
      <h2 className="text-3xl font-semibold text-gray-800 mb-6">Digital Products (0)</h2>
      ...
      <div className="overflow-x-auto shadow-lg rounded-lg border border-gray-300">
        <table className="min-w-full bg-white">
          ...
          <tbody>
            <tr>
              <td colSpan="2" className="px-6 py-4 text-center text-lg text-gray-600">
...
export default LearnerDigitalProducts;
